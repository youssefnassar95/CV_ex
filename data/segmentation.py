...
class DataReaderBinarySegmentation:
    ...
    def __init__(self, images_folder, annotations_file, transform=None, target_transform=None, 
                       no_target=False, flip=False, crop=False, crop_size=256):
        ...
        self.rcrop = RandomCrop(size=(crop_size,crop_size)) 
...
class DataReaderSemanticSegmentation:
    ...
    def __init__(self, images_folder, annotations_file, transform=None, target_transform=None, 
                    coco_ids=False, no_target=False, flip=False, crop=False, crop_size=256):
        print("loading dataset...")
        self.annotations = json.load(open(annotations_file, 'r'))
        self.transform = transform
        self.target_transform = target_transform
...
class DataReaderSingleClassSemanticSegmentationVector:
    ...
    def __init__(self, images_folder, annotations_file, transform=None, vec_transform=None, 
                target_transform=None, coco_ids=False, no_target=False, flip=False, crop=False, crop_size=256):
        print("loading dataset...")
        self.annotations = json.load(open(annotations_file, 'r'))
        self.transform = transform
